    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="px-4 md:px-10 py-10 max-w-7xl mx-auto">
        ...
        {(() => {
          ...
          return (
            <div
              className="relative h-48 md:h-64 rounded-2xl overflow-hidden mb-6 flex items-center justify-center"
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all duration-300 active:scale-95"
          >
            {bookingLoading ? '⏳ Booking...' : `Book Now — ${formatCurrency(totalPrice)}`}
          </button>
          <button
            onClick={handleAddToCartLocal}
            className="px-6 py-3 border border-green-500/50 hover:bg-green-500/20 text-green-300 font-semibold rounded-xl transition-all duration-300"
          >
            Add to Cart
          </button>
          <button
            onClick={handleAddToWishlistLocal}
            className="px-6 py-3 border border-pink-500/50 hover:bg-pink-500/20 text-pink-300 font-semibold rounded-xl transition-all duration-300"
          >
            ♥ Wishlist
          </button>
        </div>
      ...
      <div className="bg-gray-900 rounded-2xl p-6 max-w-2xl w-full border border-white/10">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <button onClick={onBook} disabled={loading} className="px-5 py-2.5 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 disabled:opacity-50 text-white font-semibold rounded-xl transition-all duration-300">
                {loading ? '⏳ Booking...' : 'Book Now'}
              </button>
              <button onClick={onAddToWishlist} className="px-5 py-2.5 border border-pink-500/50 hover:bg-pink-500/20 text-pink-300 rounded-xl transition">
                ♥ Wishlist
              </button>
              <button onClick={onAddToCart} className="px-5 py-2.5 border border-green-500/50 hover:bg-green-500/20 text-green-300 rounded-xl transition">
                Add to Cart
              </button>
              <button onClick={onClose} className="px-5 py-2.5 bg-white/5 hover:bg-white/10 text-gray-300 rounded-xl transition">
                Close
              </button>
            </div>
          </div>
